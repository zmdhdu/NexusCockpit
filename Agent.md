...
| 个性化服务 | `backend_design/nexus/core/personalization.py` | 声纹+偏好匹配+Prompt 注入 |
...
| 子目录 | 用途 | 示例文件 |
|--------|------|----------|
| `images/frontend/` | 前端界面截图 | `cockpit-main.png`, `cockpit-chat.png`, `cockpit-multi.png`, `chat-page.png`, `settings.png`, `admin.png` |
| `images/dashboard/` | 监控看板截图 | `dataplatform.png`, `middleware-monitor.png`, `grafana.png` |
| `images/architecture/` | 架构设计图 | `7-layer-arch.png`, `multi-agent-flow.png`, `RAG-Retrieval-Augmented.png`, `Vehicle-control.png`, `Voice-Interaction.png` |
| `images/misc/` | 其他截图 | `docker-compose-ps.png`, `swagger-ui.png` |
...
| 多租户上下文 | `backend_design/nexus/core/tenant_context.py` |
| 数据中台 API | `backend_design/nexus/api/routes/dataplatform.py` |
| 中间件看板 API | `backend_design/nexus/api/routes/middleware_status.py` |
| 设置中心 API | `backend_design/nexus/api/routes/settings.py` |
| Go 网关路由 | `backend_design/nexus_gate/internal/router/router.go` |
| Go 原生处理器 | `backend_design/nexus_gate/internal/handlers/handlers.go` |
| 声纹识别 | `backend_design/nexus/core/voiceprint.py` |
| 数据库管理 | `backend_design/nexus/core/db_manager.py` |
| 座舱指标 | `backend_design/nexus/observability/cockpit_metrics.py` |
| 数据保留 | `backend_design/nexus/observability/data_retention.py` |
